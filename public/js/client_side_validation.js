$('signup-form').submit((event) => {
    ...
    if (firstName === undefined || firstName === null){
        ...
        errors.firstName = "Error: Invalid input for first name. No HTML elements are allowed.";
    } else if(firstName.length < 2 || firstName.length > 25){
        errors.firstName = "Error: First name must be between 2 to 25 characters long.";
    };
    ...
    if (lastName === undefined || lastName === null){
        ...
        errors.lastName = "Error: Invalid input for last name. No HTML elements are allowed.";
    } else if(lastName.length < 2 || lastName.length > 25){
        errors.lastName = "Error: Last name must be between 2 to 25 characters long.";
    };
    ...
    if(city === undefined || city === null){
        ...
        errors.city = "Error: Invalid input for city. No HTML elements are allowed.";
    } else if (city.length < 3 || city.length > 30){
        errors.city = "Error: City cannot be less than 3 characters or longer than 30 characters.";
    };
    ...
    if(state === undefined || state === null){
        ...
        errors.state = "Error: Invalid input for state. No HTML elements are allowed.";
    } ;
    let states = [
    ...
    if (desiredPosition !== undefined || desiredPosition !== null){
        if(typeof desiredPosition !== 'string'){
            ...
            errors.desiredPosition = "Error: Desired position cannot contain any numbers.";
        } else if((/<[^>]+>/i).test(desiredPosition)){
            errors.desiredPosition = "Error: Invalid input for desired position. No HTML elements are allowed.";
        } else if(desiredPosition.length > 50){
            errors.desiredPosition = "Error: Desired position must be 50 characters or less.";
        }
    };
    ...
    if (dreamJob !== undefined || dreamJob !== null){
        if(typeof dreamJob !== 'string'){
            ...
            errors.dreamJob = "Error: Invalid input for dream job. No HTML elements are allowed.";
    ...
    if(email === undefined || email === null){
        ...
        errors.email = "Error: Invalid input for email. No HTML elements are allowed.";
    };
    ...
    if(!password){
        ...
        errors.password = 'Error: Password must contain at least one capital letter, at least one number, and at least one special character.';
